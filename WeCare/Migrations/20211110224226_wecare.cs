...
{
    public partial class wecare : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SpecialistLastname = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    SpecialistEmail = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    SpecialistArea = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    SpecialistTuitionNumber = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "d92c34b7-80c3-4e21-b455-cda6fc26f686", "2b427daf-7fe5-488a-be8b-add18ad1301b", "PATIENT", "PATIENT" },
                    { "e6ac09ad-8af7-4d47-9e0f-15f3e022fe23", "855cd6ff-f11c-4c23-87c7-786848b4cefa", "SPECIALIST", "SPECIALIST" },
                    { "3610ad0a-e648-4e13-8570-3540ad99825b", "b4fe105d-13d6-4694-b561-0a79c107ad95", "ADMIN", "ADMIN" }
                });
